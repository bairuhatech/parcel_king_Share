...
function Block5() {
  const data = [
    ...
    content: "Get a free estimate in the app, set a pickup time and location, and find a pro - all in about a minute",
  },
  {
    gif: secondImage,
    head: "Get Movin’",
  ...
  },
  {
    ...
    content: "Track the progress of your delivery, pay, tip and review - all in the app!",
  }
]
  return (
  <Row className="MainBlock5">
    {/* <div className="RouteDiv"> */}
    <Col md={24} className="Block5-Header">
    How it Works
    </Col>
    ...
    <Col md={7} sm={24} xs={24}className="firstStep-Block5" key={index}>
      ...
      <div className="HeaderCard-Block5">
        {item?.head}
      </div>
