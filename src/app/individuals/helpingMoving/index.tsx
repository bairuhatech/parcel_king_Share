    ...
    <>
      ...
      <div>
        <SectionBlock2
          Image={Block2Image}
          title1={
            "Parcel king connects you with local movers on demand when you need help moving anything from big and bulky items to small boxes nationwide. Help is just minutes away with parcel king same day and scheduled moving services. With Parcel-King, you can get help moving items the same day nationwide with our unique mobile apps, website, or our Delivery API for high volume movers. Our team of moving experts can handle most of your moving needs nationwide."
          }
          title2={
