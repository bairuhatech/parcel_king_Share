  ...
  return (
    <>
      ...
      <SectionBlock2
        Image={Image1}
        title1={
          "Parcel-King connects you with local retail Delivery Professionals on demand to help you deliver anything from big and bulky items to small parcels nationwide. Help is just a few clicks away with Parcel-King’s same day and scheduled retail delivery service. With Parcel-King, you can deliver or move furniture, mattresses, electronics, and more the same day nationwide with our unique mobile apps, website, or our Delivery API for high volume shippers. Our team of retail delivery experts can handle most of your retail delivery needs nationwide."
        }
        title2={
          "Our retail delivery service is a convenient alternative to traditional retail delivery options. With Parcel-King you can book retail delivery services on demand from almost anywhere. We can offer several levels of service including white glove, threshold, or curbside deliveries for your retail locations."
        }
        title3={
          "Modern consumer demands and the ongoing digital revolution require retail businesses to adopt a digital retail delivery and logistics strategy to support same day home delivery. Parcel-King helps you find vetted retail Delivery Professionals with the right equipment and help you manage and track your retail deliveries while saving you time and money by automating manual tasks. Parcel-King supports ship from store programs with retailers of all sizes."
        }
      />
      <Block5 />
      ...
      <SectionBlock3
        ...
        title1={
          "Parcel-King is redefining the way retailers deliver products to customers. We’re revolutionizing how businesses manage last mile and middle mile logistics through our crowdsourced network of Delivery Professionals and modern technology solutions. Businesses can leverage our retail delivery platform to reduce costs, improve delivery velocity, and provide a seamless retail delivery experience for their customers. Our retail delivery solutions include: automated dispatching, Proof of Delivery (POD) photographs, automated invoicing, rapid driver matching using Machine Learning (ML), real time order tracking, returns, and a record of each delivery."
        }
        title2={
