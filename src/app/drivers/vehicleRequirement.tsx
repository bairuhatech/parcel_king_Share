          ...
          <div className="left-side-box1">
            <div className="left-side-box2">
              ...
              <div className="vehiclerequirements-para">
                ...
                projects on the ParcelKing platform.
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ...
                documents. Drivers of courier vehicles may also act as a helper
                on a project that requires multiple delivery pros. As a helper,
                they will assist with loading and unloading. They will not carry
                cargo. Projects intended for trucks and cargo vans are generally
                much too large for passenger vehicles, including SUVs, minivans,
                and hatchbacks. Unfortunately, we don’t currently have an option
                for SUVs + trailers.
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ...
                Trucks with shortened bed lengths, or modifications that shorten
                their bed lengths or widths, may not qualify for the “pickup
                truck” classification on the ParcelKing platform. This includes,
                but is not limited to, the Honda Ridgeline Gen1 models (before
                2017) and Chevrolet Avalanche (all models). You may be asked to
                provide measurements of your vehicle bed if you have
                modifications, such as a permanent toolbox, that change the
                length of the vehicle. Any standard trucks that don’t meet the 5
                ft. requirement are still eligible to join the platform as
                couriers (see above).
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ...
                space to accept ParcelKing cargo van projects. Compact cargo
                vans that do not qualify for the “Cargo Van” classification may
              ...
              <div className="vehiclerequirements-para">
                ...
                projects and assist as a loading/unloading helper on large
                moves.
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ParcelKing accepts a range of box trucks on the platform,
                commonly between 12 and 26 feet. Tractor-trailers are not
                currently accepted on the platform. If you have a box truck that
                is less than 12 ft, you may apply under the Cargo Van vehicle
                type.
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ...
                vehicle impact cargo space or shorten bed-length, you may be
                asked to reclassify your application to that of a courier.
              </div>
              <br />
              <br />
              <div className="vehiclerequirements-para">
              ...
              <div className="vehiclerequirements-para">
                ...
                insurance requirement and we are not able to make exceptions,
                even for excellently maintained vehicles.
              </div>
              <br />
              <br />
              ...
              <br />
              <div className="vehiclerequirements-para">
                ParcelKing allows rental cargo vans and box trucks on its
                platform if the rental agreement is for a period of at least 30
                days. If your rental period is for 30 days or more, then you can
                apply with that vehicle.
              </div>
              <br />
              <br />
              ...
              <br />
              <div className="vehiclerequirements-para">
                Unfortunately, ParcelKing is not able to accept any vehicle with
              ...
              <div className="vehiclerequirements-para">
                ...
                inspection once your application is processed. The inspection
                may be completed by going to a local service station, through a
                short video, or a free video call with a ParcelKing team member.
                You are expected to demonstrate several vehicle features
                including lights, steering, brakes, horn, seat belts, and
                windshield wipers. Vehicles with worn tires or body damage may
                be asked to resolve these issues prior to being approved for the
                platform. You may re-submit your inspection after your vehicle
                has been repaired.
                <br />
                <br />
                If you have had an inspection in the last six months, you may
                alert our driver onboarding team and they will review your
                documentation. If the inspection meets our company standards,
                you will be allowed to submit it as your inspection. The team
                may request you move forward with a new inspection if your
                existing report does not meet our standards or was not done
                recently enough
              </div>
              <br />
              <br />
              ...
              <div className="vehiclerequirements-para">
                ...
                simplified inspection process. In 2022, a vehicle considered
                “new” for the purpose of a simplified vehicle inspection is a
                model year 2022 or 2023. In 2023, this will be a model year 2023
                or 2024. Because some states such as Massachusetts,
                Pennsylvania, Texas, and Virginia require annual vehicle safety
                inspections that meet our inspection criteria, applicants from
                these states may also be eligible for the simplified process.
                <br />
                <br />
              ...
              <br />
              <div className="vehiclerequirements-para">
                The vehicle should be registered and insured within the state
                you wish to accept projects in. This documentation will be
                verified during your application process. If the vehicle is
                registered under another name, you may still use it with
                permission from the owner. Our driver onboarding team may
                request a letter from the owner verifying that you have their
                permission to use the vehicle on ParcelKing’s platform.
                <br />
                <br />
                Need help identifying and finding these documents? Read our post
                here for information and tips: What Documents Do I Need to Sign
                Up For ParcelKing?
                <br />
                <br />
                -
                ...
                learn more about working ParcelKing and to start your
                application.
                <br />
                <br />
